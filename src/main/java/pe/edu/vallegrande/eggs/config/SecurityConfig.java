package edu.pe.vallegrande.eggs.config;
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(auth -> auth
                        ...
                        .pathMatchers(HttpMethod.GET, "/egg-production/**")
                        ...
                        .pathMatchers(HttpMethod.POST, "/egg-production/**")
                        .hasRole("ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/egg-production/**")
                        .hasRole("ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/egg-production/**")
                        .hasRole("ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/egg-production/**")
                        .hasRole("ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/egg-production/**")
                        .hasRole("ADMIN")
